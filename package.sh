...
notarize_app() {
    ...
    if [ $NOTARIZE_EXIT_CODE -ne 0 ]; then
        ...
        echo "xcrun notarytool store-credentials \"$KEYCHAIN_PROFILE\" --apple-id glotera.ai@gmail.com --team-id 6Q3GB859VC --password <app-specific-password>"
        return 1
    fi
